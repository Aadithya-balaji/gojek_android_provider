package com.appoets.gojek.provider.views.customviews;
...
public class SmartRatingBar extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (mRatingDrawable == null && mRatingBackgroundDrawable == null) {
            mRatingDrawable = context.getResources().getDrawable(R.drawable.star_blue);
            mRatingBackgroundDrawable = context.getResources().getDrawable(R.drawable.star_grey);
        }
    }
