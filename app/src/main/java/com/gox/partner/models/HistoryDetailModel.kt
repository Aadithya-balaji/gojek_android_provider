...
data class HistoryDetailModel(
    ...
    data class ResponseData(
        ...
        data class Delivery(
                ...
                val d_latitude: Int = 0,
                val d_longitude: Int = 0,
                val delivery_mode: Any = Any(),
                val delivery_type_id: Int = 0,
                ...
                val user_id: Int = 0,
                val user_rated: Double = 0.0,
                val deliveries: List<DeliveryData> = listOf(),
            ...
            data class Payment(
                    ...
                    val tips: Int = 0,
                    val total: Double = 0.0,
                    val total_waiting_time: Double = 0.0,
                    val user_id: Int = 0,
                    val wallet: Double = 0.0,
            ...
            data class Service(
                    val capacity: Any = Any(),
                    val delivery_types_id: Int = 0,
                    val id: Int = 0,
                    val status: Int = 0,
                    val vehicle_image: String = "",
                    val vehicle_marker: String = "",
