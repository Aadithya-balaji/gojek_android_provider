...
//        }
    ...
    private fun createDisputeRequest() {
        ...
        params.put(com.gox.base.data.Constants.Dispute.DIPUSTE_TYPE, historyDetailViewModel.disputeType.value!!)
        params.put(com.gox.base.data.Constants.Dispute.DISPUTE_NAME, historyDetailViewModel.disputeName.value!!)
        ...
        if (serviceType.equals("transport")) {
            ...
            params.put(com.gox.base.data.Constants.Dispute.REQUEST_ID, historyDetailViewModel.requestID.value.toString())
            params.put(com.gox.base.data.Constants.Dispute.PROVIDER_ID, historyDetailViewModel.providerID.value.toString())
            params.put(com.gox.base.data.Constants.Dispute.USER_ID, historyDetailViewModel.userID.value!!.toString())
            ...
            params.put(com.gox.base.data.Constants.Dispute.PROVIDER_ID, historyDetailViewModel.providerID.value.toString())
            params.put(com.gox.base.data.Constants.Dispute.USER_ID, historyDetailViewModel.userID.value!!.toString())
            params.put(com.gox.base.data.Constants.Dispute.STORE_ID, historyDetailViewModel.storeID.value.toString())
