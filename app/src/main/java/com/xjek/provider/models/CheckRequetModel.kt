...
class  CheckRequetModel{
    ...
    @Expose
    private var responseData:RequestResponseData? = null
    ...
    fun getResponseData(): RequestResponseData? {
        return responseData
    }

    fun setResponseData(responseData: RequestResponseData) {
