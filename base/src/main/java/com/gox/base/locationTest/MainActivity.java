package com.gox.base.locationTest;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Bundle key = getIntent().getBundleExtra("ResponseData");
        System.out.println("RRR :: key = " + key);
        ...
        btnDraw.setOnClickListener(v -> {
            ...
            if (markerPoints.size() >= 2) {
                ...
                System.out.println("getDirectionsUrl = " + getDirectionsUrl(origin, dest));
    ...
    private String getDirectionsUrl(LatLng origin, LatLng dest) {
        ...
        return "https://maps.googleapis.com/maps/api/directions/" + output + "?" + parameters + "&key=" + getString(R.string.google_map_key);
    }
