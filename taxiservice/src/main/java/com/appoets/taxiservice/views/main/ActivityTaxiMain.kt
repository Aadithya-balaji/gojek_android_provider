...
import com.appoets.taxiservice.views.bottomsheets.BottomStatuslayout
...
class ActivityTaxiMain : BaseActivity<com.appoets.gojek.taxiservice.databinding.ActivityTaxiMainBinding>(), ActivityTaxMainNavigator, OnMapReadyCallback, GoogleMap.OnCameraMoveListener,
        GoogleMap.OnCameraIdleListener {


    private lateinit var activityTaxiMainBinding: com.appoets.gojek.taxiservice.databinding.ActivityTaxiMainBinding
    ...
    fun initalizeMap() {
        fragmentMap = supportFragmentManager.findFragmentById(com.appoets.gojek.taxiservice.R.id.taxi_map_fragment) as SupportMapFragment
    ...
    override fun onMapReady(map: GoogleMap?) {
        mGoogleMap = map
        try {
            mGoogleMap!!.setMapStyle(MapStyleOptions.loadRawResourceStyle(this, com.appoets.gojek.taxiservice.R.raw.style_json))
